...
import com.example.mdatikurrahman.takapoya.R;
...
public class CustomAnimation extends android.view.animation.Animation implements android.view.animation.Animation.AnimationListener {
    ...
    public void revealShow(final View view, boolean b, final Dialog dialog) {
        ...
        if (b) {
            ...
            Animator animator = ViewAnimationUtils.createCircularReveal(view, w, h, 0, finalRadius);
            ...
            // Android native animator
            Animator animator = ViewAnimationUtils.createCircularReveal(view, w, h, finalRadius, 0);
            animator.setInterpolator(new LinearInterpolator());
